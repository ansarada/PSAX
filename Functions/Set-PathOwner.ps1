<#
	This is a modified version of the Set-Owner script created by Boe Prox
	It was taken from TechNet (https://gallery.technet.microsoft.com/scriptcenter/Set-Owner-ff4db177)

	All the smarts is a result of his work and the credit should go to him. We've only modified the
	cmdlet to fit our coding and naming conventions.
#>
